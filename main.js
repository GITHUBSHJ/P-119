...
math_random = Math.floor((Math.random()*quick_draw_data_set.length)+1);
Element_of_array = quick_draw_data_set[math_random];
...
function gotResults(error, results) {
	...
	document.getElementById('indet').innerHTML = 'Confidence: ' + Math.round(results[0].confidence * 100) + '%';
...
function draw()
{
	...
	if(drawn_sketch == sketch)
	{
		...
		timer_counter = 0;
		scoop = score + 1;
		document.getElementById("score").innerHTML = "Score: "+scoop;
	}
}
...
function check_sketch()
{
	...
	if(timer_counter>1000)
	{
		...
		document.getElementById("indet").innerHTML = "Accuracy: ";
	}
